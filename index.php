        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="courses.php">Maths</a>
                  <a class="dropdown-item" href="courses.php">Physics & Chemistry</a>
                  <a class="dropdown-item" href="courses.php">Biology</a>
                  <a class="dropdown-item" href="courses.php">English</a>
                  <a class="dropdown-item" href="courses.php">French</a>
                </div>
            ...
            <ul class="navbar-nav absolute-right">
              <li class="nav-item">
                <a href="login.php" class="nav-link">Freelancer</a>
              </li>
              <li class="nav-item">
                <a href="register.php" class="nav-link">Etudiant</a>
              </li>
            </ul>
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mb-5 element-animate">
              <img src="./images/iStudy-logo-copy.png"></img>
              <p class="lead"><b>World</b>'s <b>KNOWLEDGE</b> under your <b>Servitude</b>.</p>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2>Subjects</h2>
            <p class="lead">Discover any subject you want and enjoy it.</p>
          </div>
        </div>
        <div class="row top-course">
          <div class="col-md-4 col-12">
            <a href="course-single.php" class="course">
              <img src="images/maths.jpg" alt="Image placeholder">
              <h2>Mathematics</h2>
              <p>Check it Now</p>
            </a>
          </div>
          <div class="col-md-4 col-12">
            <a href="course-single.php" class="course">
              <img src="images/physics.jpg" alt="Image placeholder">
          ...
          <div class="col-md-4 col-12">
            <a href="course-single.php" class="course">
              <img src="images/biology.jpg" alt="Image placeholder">
              <h2>Biology</h2>
              <p>Check it Now</p>
            </a>
          </div>
          <div class="col-md-4 col-12">
            <a href="course-single.php" class="course">
              <img src="images/french.png" alt="Image placeholder">
              <h2>French</h2>
              <p>Check it Now</p>
            </a>
          </div>
          ...
          <div class="col-md-4 col-12">
            <a href="course-single.php" class="course">
              <img src="images/philosophy.png" alt="Image placeholder">
              <h2>philosophy</h2>
              <p>Check it Now</p>
            </a>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center"> 
          <div class="col-md-50 text-center">
            <h2>TOP Ranked Tutors by subject</h2>
            <div class="col-md-50 text-center">
              <div class="row">
    ...
    <footer class="site-footer" style="background-image: url(images/big_image_3.jpg);">
      <div class="container">
        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-md-7 text-center">
            <p>
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://dzero.pb.design" target="_blank">BMC666</a>
</p>
          </div>
        </div>
      </div>
